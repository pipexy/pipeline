...
### Added
- Changes in 1/adapters/BrowserAdapter.py
- Changes in 1/web2db.py
...
### Added
- Changes in 1/adapters/CAdapter.py
- Changes in 1/adapters/CSVAdapter.py
- Changes in 1/adapters/CppAdapter.py
- Changes in 1/adapters/DataFrameAdapter.py
- Changes in 1/adapters/DatabaseAdapter.py
- Changes in 1/adapters/ElixirAdapter.py
- Changes in 1/adapters/GraphQLAdapter.py
- Changes in 1/adapters/HTMLAdapter.py
- Changes in 1/adapters/HaskellAdapter.py
- Changes in 1/adapters/JSONAdapter.py
- Changes in 1/adapters/KotlinAdapter.py
- Changes in 1/adapters/LuaAdapter.py
- Changes in 1/adapters/MarkdownAdapter.py
- Changes in 1/adapters/PerlAdapter.py
- Changes in 1/adapters/RESTAdapter.py
- Changes in 1/adapters/R_Adapter.py
- Changes in 1/adapters/RegexAdapter.py
- Changes in 1/adapters/RustAdapter.py
- Changes in 1/adapters/SQLAdapter.py
- Changes in 1/adapters/ScalaAdapter.py
- Changes in 1/adapters/SwiftAdapter.py
- Changes in 1/adapters/TOMLAdapter.py
- Changes in 1/adapters/TypeScriptAdapter.py
- Changes in 1/adapters/XMLAdapter.py
- Changes in 1/adapters/YAMLAdapter.py
- Changes in 1/examples/BashAdapter.py
- Changes in 1/examples/CSharpAdapter.py
- Changes in 1/examples/ChainableAdapter.py
- Changes in 1/examples/GoAdapter.py
- Changes in 1/examples/HttpClientAdapter.py
- Changes in 1/examples/HttpServerAdapter.py
- Changes in 1/examples/JavaAdapter.py
- Changes in 1/examples/JavaScriptAdapter.py
- Changes in 1/examples/NodeAdapter.py
- Changes in 1/examples/PHPAdapter.py
- Changes in 1/examples/PythonAdapter.py
- Changes in 1/examples/RubyAdapter.py
- Changes in 1/examples/bash_adapter_examples.py
- Changes in 1/examples/c_sharp_adapter_examples.py
- Changes in 1/examples/chainable_adapter_examples.py
- Changes in 1/examples/conditional_adapter.py
- Changes in 1/examples/conditional_adapter_examples.py
- Changes in 1/examples/e_p_c_o_s_adapter_examples.py
- Changes in 1/examples/epcos_adapter.py
- Changes in 1/examples/escpos_adapter.py
- Changes in 1/examples/escpos_adapter_examples.py
- Changes in 1/examples/go_adapter_examples.py
- Changes in 1/examples/http_client_adapter_examples.py
- Changes in 1/examples/http_server_adapter_examples.py
- Changes in 1/examples/java_adapter_examples.py
- Changes in 1/examples/java_script_adapter_examples.py
- Changes in 1/examples/m_l_model_prediction_example.py
- Changes in 1/examples/message_queue_adapter.py
- Changes in 1/examples/message_queue_adapter_examples.py
- Changes in 1/examples/ml_adapter.py
- Changes in 1/examples/ml_adapter_basic_prediction.py
- Changes in 1/examples/opencv_adapter.py
- Changes in 1/examples/pcl_adapter.py
- Changes in 1/examples/python_adapter_examples.py
- Changes in 1/examples/rpi_audio_adapter.py
- Changes in 1/examples/rtsp_adapter.py
- Changes in 1/examples/s_q_l_adapter_examples.py
- Changes in 1/examples/stt_adapter.py
- Changes in 1/examples/tts_adapter.py
- Changes in 1/examples/websocket_adapter.py
- Changes in 1/examples/xml_adapter_examples.py
- Changes in 1/examples/zpl_adapter.py
- Changes in 1/tests/AdapterFactoryUnitTests.py
- Changes in 1/tests/BashAdapterTests.py
- Changes in 1/tests/BashAdapterUnitTests.py
- Changes in 1/tests/CSVAdapterUnitTestSuite.py
- Changes in 1/tests/CSharpAdapterUnitTests.py
- Changes in 1/tests/ChainableAdapterUnitTests.py
- Changes in 1/tests/GoAdapterTestCases.py
- Changes in 1/tests/GraphQLAdapterUnitTests.py
- Changes in 1/tests/HttpClientAdapterTests.py
- Changes in 1/tests/JSONAdapterUnitTests.py
- Changes in 1/tests/JavaScriptAdapterTests.py
- Changes in 1/tests/PythonAdapterUnitTestCases.py
- Changes in 1/tests/RESTAdapterUnitTests.py
- Changes in 1/tests/RubyAdapterTestCases.py
- Changes in 1/tests/ShellAdapterUnitTests.py
- Changes in 1/tests/SqlAdapterUnitTestCases.py
- Changes in 1/tests/XMLAdapterUnitTests.py
- Changes in 1/tests/test_audio_adapter.ipynb
- Changes in 1/tests/test_integration.py
- Changes in 1/tests/test_restapi_adapter.py
- Changes in 1/tests/test_utilities.py
- Changes in 1/tests/test_xml_adapter.py
- Changes in 1/tests/test_yaml_adapter.py
